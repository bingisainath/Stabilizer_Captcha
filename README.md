...
1.  **The "OODA Loop" Trap (Latency):**
    ...
    - _Result:_ GPT-4 Vision and Selenium bots fail due to lag.
...
2.  **Dynamic Chaos (Anti-RL):**
    ...
    - _Result:_ Reinforcement Learning (Q-Learning) agents fail because they cannot adapt their policy to changing physics in real-time.
...
3.  **The "Reflex Trap" (Anti-PID):**
    ...
    - _Result:_ Scripted bots balance the rod perfectly but are rejected during verification.
